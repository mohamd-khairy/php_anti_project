...
define("HostName", "http://localhost/anti/");

define("PER_PAGE_COUNT", 20);

define("Controller_FOLDER", __DIR__ . DS . 'controller');
define("Upload_FOLDER", __DIR__ . DS . 'img');
...
set_include_path(get_include_path() . PS . ADMIN_Controllers . PS . ADMIN_Models . PS . ADMIN_Views . PS . Controller_FOLDER . PS . Views_FOLDER . PS . LIBS_FOLDER . PS . MODELS_FOLDER);
