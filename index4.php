...
define('CONSUMER_KEY', 'umz32H8pg5FP7CgcTpM5QByap');
define('CONSUMER_SECRET', 'mMgAE3eGANoFRm4GMC5FPNKDVKnEoD0v6aom9c38een6WrBY4r');
define('OAUTH_CALLBACK', 'http://localhost/anti/index4.php');
// start the session
session_start();
...
if(isset($login_url) && !isset($_SESSION['data'])){
  ...
  //  print_r($_SESSION['data']);
    header('location:index.php?rt=HomePage/twitter');
